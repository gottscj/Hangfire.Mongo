...
namespace Hangfire.Mongo
{
    ...
    /// Fetches job from DB
    /// </summary>
    public class AsyncMongoJobFetcher : MongoJobFetcher
    {
        ...
        public AsyncMongoJobFetcher(HangfireDbContext dbContext, MongoStorageOptions storageOptions,
            IJobQueueSemaphore semaphore) : base(dbContext, storageOptions, semaphore)
        {
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public override MongoFetchedJob TryAllQueues(string[] queues, CancellationToken cancellationToken)
        {
